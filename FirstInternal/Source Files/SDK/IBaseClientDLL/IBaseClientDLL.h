...
{
public:
	virtual int				Connect(NTypedefs::t_pfnCreateInterface appSystemFactory, CGlobalVarsBase *pGlobals) = 0;
	virtual int				Disconnect(void) = 0;
	virtual int				Init(NTypedefs::t_pfnCreateInterface appSystemFactory, CGlobalVarsBase *pGlobals) = 0;
