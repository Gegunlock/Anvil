...
//-------------------------------------------------------------------
	virtual int                   GetIntersectingSurfaces(/*const model_t *model, const Vector &vCenter, const float radius, const bool bOnlyVisibleSurfaces, SurfInfo *pInfos, const int nMaxInfos*/) = 0; // Dont Call
	virtual Vector                GetLightForPoint(const Vector &pos, bool bClamp) = 0;
	virtual /*IMaterial**/ void        TraceLineMaterialAndLighting(const Vector &start, const Vector &end, Vector &diffuseLightColor, Vector& baseColor) = 0; // Dont Call
	virtual const char*           ParseFile(const char *data, char *token, int maxlen) = 0;
	virtual bool                  CopyFile(const char *source, const char *destination) = 0;
	virtual void                  GetScreenSize(int& width, int& height) = 0;
	virtual void                  ServerCmd(const char *szCmdString, bool bReliable = true) = 0;
	virtual void                  ClientCmd(const char *szCmdString) = 0;
	virtual bool                  GetPlayerInfo(/*int ent_num, PlayerInfo *pinfo*/) = 0; // Dont Call
	virtual int                   GetPlayerForUserID(int userID) = 0;
	virtual /*client_textmessage_t**/ void TextMessageGet(const char *pName) = 0; // 10 // Dont Call
	virtual bool                  Con_IsVisible(void) = 0;
	virtual int                   GetLocalPlayer(void) = 0;
	virtual const /*model_t**/ void        LoadModel(const char *pName, bool bProp = false) = 0; // Dont Call
	virtual float                 GetLastTimeStamp(void) = 0;
	virtual /*CSentence**/ void            GetSentence(/*CAudioSource *pAudioSource*/) = 0; // 15 // Dont Call
	virtual float                 GetSentenceLength(/*CAudioSource *pAudioSource*/) = 0; // Dont Call
	virtual bool                  IsStreaming(/*CAudioSource *pAudioSource*/) const = 0; // Dont Call
	...
	virtual const /*VMatrix&*/ void       WorldToScreenMatrix() = 0; // Dont Call
	virtual const /*VMatrix&*/ void        WorldToViewMatrix() = 0; // Dont Call
	virtual int                   GameLumpVersion(int lumpId) const = 0;
	virtual int                   GameLumpSize(int lumpId) const = 0; // 40
	virtual bool                  LoadGameLump(int lumpId, void* pBuffer, int size) = 0;
	virtual int                   LevelLeafCount() const = 0;
	virtual /*ISpatialQuery**/ void        GetBSPTreeQuery() = 0; // Dont Call
	...
	virtual void                  Mat_Stub(/*IMaterialSystem *pMatSys*/) = 0; // 50 // Dont Call
	...
	virtual int                   GetFrustumList(/*Frustum_t **pList, int listMax*/) = 0;// Dont Call
	virtual bool                  ShouldUseAreaFrustum(int i) = 0;
	virtual void                  SetAudioState(/*const AudioState_t& state*/) = 0; // Dont Call
	...
	virtual /*INetChannelInfo**/ void      GetNetChannelInfo(void) = 0; // Dont Call
	virtual void                  DebugDrawPhysCollide(/*const CPhysCollide *pCollide, IMaterial *pMaterial, const matrix3x4_t& transform, const Color &color*/) = 0; //79 // Dont Call
	...
	virtual void                  SetAchievementMgr(/*IAchievementMgr *pAchievementMgr*/) = 0;// Dont Call
	virtual /*IAchievementMgr**/ void      GetAchievementMgr() = 0;// Dont Call
	...
	virtual /*ISPSharedMemory**/ void      GetSinglePlayerSharedMemorySpace(const char *szName, int ent_num = (1 << 11)) = 0;// Dont Call
	virtual void                  ComputeLightingCube(const Vector& pt, bool bClamp, Vector *pBoxColors) = 0;
	virtual void                  RegisterDemoCustomDataCallback(/*const char* szCallbackSaveID, pfnDemoCustomDataCallback pCallback*/) = 0;// Dont Call
	virtual void                  RecordDemoCustomData(/*pfnDemoCustomDataCallback pCallback, const void *pData, size_t iDataLength*/) = 0;// Dont Call 
	...
	virtual void                  SetGamestatsData(/*CGamestatsData *pGamestatsData*/) = 0; // Dont Call
	virtual /*CGamestatsData**/ void       GetGamestatsData() = 0; // Dont Call
	...
	virtual /*CSteamAPIContext**/ void    GetSteamAPIContext() = 0; // Dont Call
	...
	virtual void                  ServerCmdKeyValues(/*KeyValues *pKeyValues*/) = 0; // 203// Dont Call
	virtual void                  SpherePaintSurface(/*const model_t* model, const Vector& location, unsigned char chr, float fl1, float fl2*/) = 0;// Dont Call
	virtual bool                  HasPaintmap(void) = 0;
	virtual void                  EnablePaintmapRender() = 0;
	virtual void                  SphereTracePaintSurface(/*const model_t* model, const Vector& position, const Vector &vec2, float radius, /*CUtlVector<unsigned char, CUtlMemory<unsigned char, int>> int& utilVecShit*/) = 0; // Dont Call
	virtual void                  RemoveAllPaint() = 0;
	virtual void                  PaintAllSurfaces(unsigned char uchr) = 0;
	virtual void                  RemovePaint(/*const model_t* model*/) = 0; // Dont Call
	virtual bool                  IsActiveApp() = 0;
	virtual bool                  IsClientLocalToActiveServer() = 0;
	virtual void                  TickProgressBar() = 0;
	virtual /*InputContextHandle_t*/ void  GetInputContext(int /*EngineInputContextId_t*/ id) = 0; // Dont Call
	...
	virtual void                  StartLoadingScreenForKeyValues(/*KeyValues* values*/) = 0; // Dont Call
	...
	virtual void                  SetDemoImportantEventData(/*const KeyValues* values*/) = 0; // Dont Call
